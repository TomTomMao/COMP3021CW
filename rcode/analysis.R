...
# Q2: Is there any special pattern of price

  # bar chart (not expressive)
  airbnb %>%
    group_by(location) %>%
...
# Q4: How do the expensive rooms differ from the cheap rooms in terms of the distance to the metro station and city center?
  ...
  # using 2 boxplots for each variables. because there are 4 groups so not using histogram for comparison
...
# Q5 Why there are some rooms that are far away from the city centers and far away from the metro stations can sell a good price?
